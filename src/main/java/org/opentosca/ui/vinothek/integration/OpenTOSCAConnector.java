...
public class OpenTOSCAConnector implements TOSCARuntimeConnector {
	 ...
	 */
	@Override
	public String instantiateServiceTemplate(String self, String containerUrl, String applicationId, String optionId,
		...
		planInputMessage = planInputMessage.replace("%CSARENTRYPOINT-URL%",
				CONFIG.CONTAINER_API + "/CSARs/" + application.getCsarName());
		...
		// fetch it itself)
		String planInvokerCallbackEndpoint = "http://" + client.getContainerHost() + ":9763/services/"
				+ application.getCsarName() + "InvokerService/";
		...
		String planEndpoint = "http://" + client.getContainerHost() + ":9763/services/"
				+ selectedOption.getPlanServiceName() + "/";
	...
	@Override
	public String terminateServiceTemplate(String self, String containerUrl, String applicationId,
			String selfserviceServiceInstance) {
		VinothekContainerClient client = new VinothekContainerClient(containerUrl);
		...
		// fetch it itself)
		String planInvokerCallbackEndpoint = "http://" + client.getContainerHost() + ":9763/services/"
				+ wrapper.getCsarName() + "InvokerService/";
		planInputMessage = planInputMessage.replace("%PLANCALLBACKINVOKER-URL%", planInvokerCallbackEndpoint);

		// Send plan input message to plan endpoint
		String planEndpoint = "http://" + client.getContainerHost() + ":9763/services/"
				+ foundTerminationOption.getPlanServiceName() + "/";
